...
namespace TextSimplification.Services
{
    public class TextSimplificationService : ITextSimplificationService
    {
        ...
        private string GeneratePrompt(string text, ReadingLevel level)
        {
            ...
            {
                ReadingLevel.Child => @"Rewrite this for a young child (age 8-12):
...
Text to explain:",
                ...
                ReadingLevel.Teen => @"Rewrite this for a teenager (age 13-17):
...
Text to explain:",
                ...
                ReadingLevel.Adult => @"Rewrite this for a general adult audience:
...
Text to explain:",
                ...
                ReadingLevel.Expert => @"Restructure this text for a physics expert while maintaining technical rigor:
...
Text to explain:",
                ...
                _ => "Write exactly 4 clear sentences explaining this text:"
            };
